...
import { DeleteColumn } from './CardDeleteColumn'
...
const Cards = () => {
    const dispatch = useDispatch()
    const data = useSelector((state) => state.crmCards.data.cardsList)
    const filterData = useSelector((state) => state.crmCards.data.filterData)

    const { pageIndex, pageSize, sort, query, total } = useSelector(
        (state) => state.crmCards.data.tableData
    )
